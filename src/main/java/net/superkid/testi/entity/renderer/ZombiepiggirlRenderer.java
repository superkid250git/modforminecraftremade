...
import net.superkid.testi.entity.ZombiepiggirlEntity;
...
@OnlyIn(Dist.CLIENT)
public class ZombiepiggirlRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ZombiepiggirlEntity.entity, renderManager -> {
