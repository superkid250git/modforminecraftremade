...
import net.superkid.testi.gui.AdminstickguiGuiWindow;
import net.superkid.testi.gui.AdminstickguiGui;
...
public class AdminstickItem extends TestiModElements.ModElement {
	@ObjectHolder("testi:adminstick")
	public static final Item block = null;
	public AdminstickItem(TestiModElements instance) {
		super(instance, 59);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof AdminstickguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Adminstick");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new AdminstickguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
