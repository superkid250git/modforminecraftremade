...
import net.superkid.testi.gui.ConverterguiGui;
...
public class ConverterBlock extends TestiModElements.ModElement {
	@ObjectHolder("testi:converter")
	public static final Block block = null;
	@ObjectHolder("testi:converter")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ConverterBlock(TestiModElements instance) {
		super(instance, 58);
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ConverterguiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
