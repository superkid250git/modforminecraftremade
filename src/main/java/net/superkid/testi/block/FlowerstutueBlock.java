...
public class FlowerstutueBlock extends TestiModElements.ModElement {
	@ObjectHolder("testi:flowerstutue")
	public static final Block block = null;
	public FlowerstutueBlock(TestiModElements instance) {
		super(instance, 70);
	}
